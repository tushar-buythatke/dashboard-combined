...
import { apiService, PLATFORMS, SOURCES, FEATURE_API_MAP } from '@/services/apiService';
            ...
            <div className="flex justify-between items-center border-b pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-sm text-muted-foreground">
                        Feature: {FEATURE_API_MAP[featureId] || featureId}
                    </span>
                </div>
                                ...
                                <Card key={panel.panelId} className="relative">
                                    ...
                                    <CardContent className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 p-4 bg-muted/20 rounded-lg">
                                            <div className="space-y-2">
                                                <Label>Events ({FEATURE_API_MAP[featureId] || featureId})</Label>
                                                <MultiSelectDropdown
