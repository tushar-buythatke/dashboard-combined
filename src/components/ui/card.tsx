...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl text-card-foreground',
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('leading-none font-semibold tracking-tight text-gray-800 dark:text-gray-100', className)}
      {...props}
    />
  )
}
